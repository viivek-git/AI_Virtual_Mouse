...
class handDetector():
    ...
    def findPosition(self, img, handNo=0, draw=True):   # Fetches the position of hands
        ...
        if self.results.multi_hand_landmarks:
            ...
            for id, lm in enumerate(myHand.landmark):
                ...
                if draw:
                    cv2.circle(img, (cx, cy), 5, (300, 0, 300), cv2.FILLED)
    ...
    def findDistance(self, p1, p2, img, draw=True,r=15, t=3):   # Finds distance between two fingers
        ...
        if draw:
            cv2.line(img, (x1, y1), (x2, y2), (300, 0, 300), t)
            cv2.circle(img, (x1, y1), r, (300, 0, 300), cv2.FILLED)
            cv2.circle(img, (x2, y2), r, (300, 0, 300), cv2.FILLED)
            cv2.circle(img, (cx, cy), r, (0, 0, 300), cv2.FILLED)
