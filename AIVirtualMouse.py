...
while True:
    ...
    if len(lmList) != 0:
        ...
        if fingers[1] == 1 and fingers[2] == 0:
            ...
            cv2.circle(img, (x1, y1), 15, (300, 0, 300), cv2.FILLED)
        ...
        if fingers[1] == 1 and fingers[2] == 1:
            ...
            if length < 40:
                cv2.circle(img, (lineInfo[4], lineInfo[5]), 15, (0, 300, 0), cv2.FILLED)
                autopy.mouse.click()
    ...
    fps = 1/(cTime-pTime)
    pTime = cTime
    cv2.putText(img, str(int(fps)), (28, 58), cv2.FONT_HERSHEY_PLAIN, 3, (300, 8, 8), 3)
